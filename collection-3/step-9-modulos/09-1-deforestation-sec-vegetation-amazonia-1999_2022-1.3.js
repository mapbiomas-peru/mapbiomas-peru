...
// product versions
var inputVersion = '0-2';
var outputVersion = '1';
//
var yearVis = [2010, 2022]; // VISUALIZAR MOS Y CLAS C2, 2022 NO PRESENTA RESULTADOS
...
// assets
var assetInput  =  'projects/mapbiomas-raisg/COLECCION6/INTEGRACION/mapbiomas_raisg_panamazonia_collection6_integration-'+ inputVersion
var assetOutput = 'projects/mapbiomas-raisg/MAPBIOMAS-PERU/COLECCION3/PRODUTOS-1/deforestacion-vegetacion-secundaria';
...
var integrated = ee.Image(assetInput).select(bandNames)
                                              // .filter(ee.Filter.eq('descripcion', 'integracion-ft'))
                                              // .filter(ee.Filter.eq('version', inputVersion))
                                              // .mosaic();

// var biomas = ee.Image(assetBiomas).eq(4);
